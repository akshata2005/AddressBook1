...
namespace AddressBookSystem1
{
    ...
    {
        static CreateAddressBook addressBookMain = new CreateAddressBook();
        static Dictionary<string, CreateAddressBook> addressBook = new Dictionary<string, CreateAddressBook>();
        ...
        public void ReadInput()
        {
            ...
            while (CONTINUE)
            {
                ...
                {
                    case 1:
                        AddressBookDictionary.AddBook();
                        break;
                    case 2:
                        AddDetails(AddressBookDictionary.BookName(addressBook));
                        break;
                    case 3:
                        addressBookMain = AddressBookDictionary.BookName(addressBook);
        ...
        public static void AddDetails(CreateAddressBook addressMain)
        {
        ...
        /// <returns></returns>
        public static CreateAddressBook BookName(Dictionary<string, CreateAddressBook> addBook)
        {
            addressBook = addBook;
            Console.WriteLine("Enter address book name:");
            string name = Console.ReadLine();
            CreateAddressBook address = addressBook[name];
            return address;
        }
    }
}
