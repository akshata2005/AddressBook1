...
namespace AddressBookSystem1
{
    ...
    {
        AddressBookclass address2 = new AddressBookclass();
            ...
            while (CONTINUE)
            {
                ...
                switch (choice)
                {
                    case 1:
                        ...
                        break;
                    case 2:
                        address2.DisplayContact();
                        break;
                    case 3:
                        Console.WriteLine("Enter the first name of person");
                        string name = Console.ReadLine();
                        address2.EditContact(name);
                        break;
                    case 4:
                        Console.WriteLine("Enter the first name of person");
                        string dName = Console.ReadLine();
                        address2.DeleteContact(dName);
                        break;
                    case 0:
                        CONTINUE = false;
                        break;
        ...
        public static void AddDetails(AddressBookclass addressclass)
        {
